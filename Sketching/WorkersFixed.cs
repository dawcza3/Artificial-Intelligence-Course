    ...
    public class WorkersFixed
    {
        ...
        public static void Start()
        {
            try
            {
                ...
                // indeks w tablicy to zadanie, wartość to numer pracownika który je wykona
                int[] state = RandomState(problemData);

                 // funkcja energii dodaje energie w przypadku gdy jakis pracownik ma do wykonania wiecej niz 1 zadanko
